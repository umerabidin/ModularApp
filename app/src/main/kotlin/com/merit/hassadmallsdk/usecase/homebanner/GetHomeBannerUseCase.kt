package com.merit.hassadmallsdk.usecase.homebanner
...
class GetHomeBannerUseCase @Inject constructor(
    ...
    override suspend fun run(): Resource<HomeBannerResponse> {
        return try {
            val response = getCountriesRepository.getHomeBanners()
